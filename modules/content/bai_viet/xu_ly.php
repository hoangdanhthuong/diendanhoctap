...
if($hinh_anh != ''){
	...
	$sql = "INSERT INTO cau_hoi(tieu_de, id_chu_de, noi_dung, ten_dang_nhap, ngay_tao, tinh_trang) VALUES ('".$tieu_de."','".$id_chu_de."','".$noi_dung."','".$_SESSION['dang_nhap_dien_dan']."','".date('Y-m-d')."',1)";
}
