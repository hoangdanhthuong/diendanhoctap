...
$sql ="SELECT a.*, b.ten as ten_loai_tin FROM chu_de a, loai_tin b where a.id_loai_tin = b.id order by id ";
$result = mysqli_query($conn, $sql);
?>
<div class="container-fluid bg-info">
	<div class="container">
		<div id="tieu_de">
			<h3><a href="index.php?quanly=chude&ac=them" class="btn btn-info"><i class="glyphicon glyphicon-plus"></i>Thêm</a></h3>
		</div>
		<table class="table table-hover text-center table-bordered " id="table_loai_tin">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $row['ten_loai_tin'];?></td>
					<td><?php echo $row['thu_tu'];?></td>
					<td><?php echo $row['tinh_trang'];?></td>
					<td><a href="index.php?quanly=chude&ac=sua&id=<?php echo $row['id'];?>"><i class="glyphicon glyphicon-edit"></i></a></td>
					<td><a href="modules/content/quan_ly_chu_de/xu_ly.php?id=<?php echo $row['id'];?>"><i class="glyphicon glyphicon-trash"></i></a></td>
				</tr>
				<?php
					}
				?>
