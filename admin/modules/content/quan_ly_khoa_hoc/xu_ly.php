...
$chu_de = $_POST['chu_de'];
if(isset($_POST['them'])){
	$sql = "INSERT INTO khoa_hoc(tieu_de, noi_dung, hinh_anh, thu_tu, thoi_gian_bat_dau, thoi_gian_ket_thuc, tinh_trang, id_chu_de) VALUES ('".$tieu_de."', '".$noi_dung."','".$file_image."','".$thu_tu."','".$start_date."','".$end_date."', '".$tinh_trang."',".$chu_de.")";
	...
	if(!mysqli_query($conn, $sql)){
		header("location: ../../../index.php?quanly=quan_ly_khoa_hoc&ac=sua&error=1");
	}else{
		header("location: ../../../index.php?quanly=quan_ly_khoa_hoc");
	}
}else{
