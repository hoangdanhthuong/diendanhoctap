...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 25, 2018 lúc 01:55 SA
...
(19, '1232', 'nguyenvannam', '2018-05-14 04:26:16', 3),
(20, 'sdfsdf', 'nguyenhuungoc', '2018-05-15 13:32:28', 7),
(21, '1516556', 'nguyenhuungoc', '2018-05-15 13:32:37', 7),
(22, 'sầdsf', 'nguyenhuungoc', '2018-05-15 13:34:19', 8),
(23, 'sdafasdf', 'nguyenhuungoc', '2018-05-15 13:34:24', 8),
(24, '12345', 'nguyenhuungoc', '2018-05-16 07:47:18', 11),
(25, '45678', 'nguyenhuungoc', '2018-05-16 07:47:27', 11),
(26, 'Vâng tôi thích', 'nguyenhuungoc', '2018-05-16 07:47:50', 10),
(27, '12345', 'nguyenhuungoc', '2018-05-16 07:48:40', 12),
(28, 'xykhf\r\n\r\n', 'nguyenhuungoc', '2018-05-24 11:45:57', 7);
...
INSERT INTO `cau_hoi` (`id`, `id_chu_de`, `tieu_de`, `noi_dung`, `hinh_anh`, `ten_dang_nhap`, `ngay_tao`, `tinh_trang`) VALUES
(1, 1, 'Lỗi màn hình xanh ', 'man hinh xanh', 'uploads/1000000.png', 'nguyenhuungoc', '2018-05-09', 0),
(2, 5, 'Học tiếng anh cần những gì', 'Em đang cần học tiếng anh', 'uploads/1000000.jpg', 'nguyenhuungoc', '2018-05-09', 1),
(3, 0, 'Hôm nay là thứ mấy', 'Chắc chắn là thứ hai', 'uploads/8390228.jpg', 'nguyenhuungoc', '2018-05-09', 1),
(4, 6, 'Lỗi code C++', 'Lỗi như sau Sửa mãi không được.', 'uploads/4134674.png', 'ngoc123', '2018-05-09', 1),
(5, 5, 'Làm sao để gán tất cả các giá trị ở cây nhị phân sang mảng ?', 'Học cây nhị phân', 'uploads/4006408.jpg', 'nguyenvancuong', '2018-05-13', 1),
(6, 10, 'Lỗi Angular 4 tự động save liên tục', 'Khắc phục lỗi', 'uploads/5031707.png', 'nguyenducmanh', '2018-05-14', 1),
(7, 5, 'Cách tính số ngày trong C++', 'Cách khai báo', 'uploads/2987426.jpg', 'nguyenvannam', '2018-05-14', 1),
(9, 11, 'Lỗi Angular 4 tự động save liên tục', 'Khắc phục lỗi', 'uploads/5031707.png', 'nguyenducmanh', '2018-05-14', 1),
(10, 26, 'Hôm nay có bài nhạc sẽ như thế này ', 'Ai hát trước sẽ thắng..', 'uploads/9285064.png', 'nguyenhuungoc', '2018-05-16', 1),
(11, 27, 'Hôm nay là thứ mấy', 'Chắc chắn là thứ 2', 'uploads/9103790.jpg', 'nguyenhuungoc', '2018-05-16', 1),
(12, 28, 'Một hai ba là tôi', 'Vậy tôi là ai?', 'uploads/2257659.jpg', 'nguyenhuungoc', '2018-05-16', 1),
(21, 28, 'fđfdssd', 'dsfsdf', 'uploads/8475372.jpg', 'nguyenhuungoc', '2018-05-21', 1),
(22, 26, 'thu gian', '123465', 'uploads/4479095.jpg', 'nguyenhuungoc', '2018-05-23', 1);
...
(26, 'Nhạc giải trí', 5, 1, 1),
(27, 'Game', 5, 2, 1),
(28, 'Giải trí tổng hợp', 5, 3, 1);
...
(5, 15, 'Học tiếng anh giao tiếp', '<p>- Mất căn bản Tiếng anh kh&ocirc;bg biết phải bắt đầu lai như thế n&agrave;o ?</p>\r\n<p>- Ch&aacute;n nản với việc học tiếng anh nhiều năm nhưng chưa thể tiến bộ ?</p>\r\n<p>- Ngữ ph&aacute;p tốt nhưng yếu kỹ năng nghe n&oacute;i do chưa học đ&uacute;ng phương ph&aacute;p ?</p>\r\n<p>- Kh&ocirc;ng thế ph&aacute;t &acirc;m chuẩn, bị vấp, b&iacute; &yacute; trong c&aacute;c t&igrave;nh huống diễn đạt thực tế ?</p>', '1828125.jpg', '2018-05-16', '2018-05-31', 1, 1),
...
(5, 'Thư giãn', 'index.php?xem=thugian', 4, 1);
...
(1, 20, 'Tài liệu C#', 'Toàn bộ nội dung cần học trong file này', 'https://drive.google.com/open?id=0B2dOEaO6sCS9dnpUMExwc3N0akE', '', '2018-05-14', 1, 1),
...
(4, 21, 'Tài liệu lập trình Android', '<p>Nội dung cơ bản của android</p>', 'https://drive.google.com/open?id=0B2dOEaO6sCS9LUU0TFV0MVRSU0U', '2018-05-142819061.png', '2018-05-14', 3, 1),
(5, 23, 'Tài liệu lập trình Php', '<p>Nội dung cơn bản của php</p>', 'https://drive.google.com/open?id=0B2dOEaO6sCS9STA1TDJiekJKSEU', '2018-05-143683960.jpg', '2018-05-14', 4, 1);
...
(7, 'nguyenvancuong', '12345', 'cuong@gmail.com', 'nguyễn văn cường', 0, 0),
...
--
-- Cấu trúc đóng vai cho view `thanh_vien_binh_luan`
-- (See below for the actual view)
--
CREATE TABLE `thanh_vien_binh_luan` (
`id` int(11)
...
--
-- Cấu trúc cho view `bai_viet_thanh_vien`
--
DROP TABLE IF EXISTS `bai_viet_thanh_vien`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bai_viet_thanh_vien`  AS  (select `a`.`id` AS `id`,`a`.`id_chu_de` AS `id_chu_de`,`a`.`tieu_de` AS `tieu_de`,`a`.`noi_dung` AS `noi_dung`,`a`.`hinh_anh` AS `hinh_anh`,`a`.`ten_dang_nhap` AS `ten_dang_nhap`,`a`.`ngay_tao` AS `ngay_tao`,`a`.`tinh_trang` AS `tinh_trang`,`b`.`id` AS `id_dang_nhap` from (`cau_hoi` `a` join `thanh_vien` `b`) where (`a`.`ten_dang_nhap` = `b`.`ten_dang_nhap`)) ;
...
--
-- Cấu trúc cho view `thanh_vien_binh_luan`
--
DROP TABLE IF EXISTS `thanh_vien_binh_luan`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `thanh_vien_binh_luan`  AS  (select `a`.`id` AS `id`,`a`.`noi_dung` AS `noi_dung`,`a`.`ten_dang_nhap` AS `ten_dang_nhap`,`a`.`thoi_gian` AS `thoi_gian`,`a`.`id_cau_hoi` AS `id_cau_hoi`,`b`.`id` AS `id_dang_nhap` from (`binh_luan` `a` join `thanh_vien` `b`) where (`a`.`ten_dang_nhap` = `b`.`ten_dang_nhap`)) ;
